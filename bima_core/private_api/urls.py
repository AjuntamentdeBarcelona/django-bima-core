...
urlpatterns = [
    ...
    url(r'^photos/youtube/$', YoutubeChannelList.as_view(), name='photo-youtube-channels'),
    url(r'^photos/youtube/upload/$', YoutubeUpload.as_view(), name='photo-youtube-upload'),
